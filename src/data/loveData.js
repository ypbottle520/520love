...
export const passwordLayers = [
  {
    code: '212',
    title: '第一层：距离',
    hint: '从10月20日走到5月20日，一共走了多少天？',
    softHint: '不是520，也不是1020，是我们之间这段时间的长度。',
    secretHint: '答案是一个三位数，它也是小杰生日的数字组合。',
    success: '这是从10月20日走到5月20日的距离。',
  },
  {
    code: '1020',
    title: '第二层：开始',
    hint: '我们正式在一起的那一天。',
    softHint: '四位数字，月份在前，日期在后。',
    secretHint: '那一天，是小杰开始认真把小昕放进生活里的日子。',
    success: '这是我们开始的那一天。',
  },
  {
    code: '0212',
    title: '第三层：小杰',
    hint: '小杰来到这个世界的日子。',
    softHint: '四位数字，月份补0，日期两位。',
    secretHint: '2月12日，写成四位数字。',
    success: '这是小杰的生日。',
  },
  {
    code: '0716',
  ...
  },
  {
    ...
    title: '第五层：今天',
    hint: '今天最适合说喜欢你的数字。',
    softHint: '三个数字，也是小杰今天最想说的话。',
    secretHint: '不是复杂密码，就是520。',
    success: '这是今天，也是我想认真说喜欢你的日子。',
  },
]
...
export const loveData = {
  ...
  games: {
    ...
    code: {
      title: '隐藏口令 / 密码终章',
      subtitle: '解开小杰认真藏起来的一层层喜欢',
      intro: '有些数字不是密码，\n是我们之间的小小坐标。\n\n小昕要一层一层打开，\n才能看到小杰藏到最后的话。',
      inputLabel: '输入当前密码',
      inputPlaceholder: '输入这一层的密码',
      submit: '打开这一层',
      wrong: '还差一点点，再想想我们之间的小暗号。',
      softWrong: '给小昕一点更明显的线索。',
      secretPrefix: '偷偷提示：',
      nextLayer: '打开下一层',
      finalFragment: '获得第五枚心动碎片',
